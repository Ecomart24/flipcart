...
const amazonCategoryProducts: Product[] = [
  {
    id: 2001,
    name: "Samsung Galaxy S24 5G (8GB RAM, 128GB)",
    price: 62999,
    originalPrice: 74999,
    discount: 16,
    rating: 4.5,
    ...
    brand: "Amazon",
    badge: "Amazon Choice",
    description: "Flagship Samsung 5G smartphone with pro camera and premium AMOLED display.",
    highlights: ["8GB RAM", "128GB Storage", "5G Connectivity", "AMOLED Display"],
    inStock: true,
  },
  {
    id: 2002,
    name: "HP Laptop 15s (Intel Core i5, 16GB RAM)",
    price: 52990,
    originalPrice: 68990,
    discount: 23,
    rating: 4.3,
    reviews: 6120,
    image: "https://m.media-amazon.com/images/I/61ivdpWBLqL.jpg",
    category: "Laptops",
    brand: "Amazon",
    badge: "Best Seller",
    description: "Thin and light HP laptop for office, study and daily multitasking.",
    highlights: ["Intel Core i5", "16GB RAM", "512GB SSD", "Full HD Display"],
    inStock: true,
  },
  {
    id: 2003,
    ...
    rating: 4.2,
    reviews: 25780,
    image: "https://m.media-amazon.com/images/I/61VKXOPKdaL.jpg",
    category: "Electronics",
    brand: "Amazon",
    description: "Bluetooth TWS earbuds with clear call quality and all-day battery backup.",
    highlights: ["Bluetooth 5.3", "Fast Charging", "Touch Controls", "Low Latency Mode"],
    inStock: true,
  },
  {
    id: 2004,
    name: "Acer 32-inch HD Ready Smart TV",
    price: 13999,
    originalPrice: 21999,
    discount: 36,
    rating: 4.1,
    reviews: 11204,
    image: "https://m.media-amazon.com/images/I/81knarlqqaL._AC_UY218_.jpg",
    category: "TVs",
    brand: "Amazon",
    description: "Compact smart LED TV with streaming apps and vivid color output.",
    highlights: ["HD Ready Display", "Smart TV Apps", "Dual Speakers", "Multiple HDMI Ports"],
    inStock: true,
  },
  {
    id: 2005,
    name: "Apple iPad (11th Generation, Wi-Fi)",
    price: 36900,
    originalPrice: 41900,
    discount: 12,
    rating: 4.6,
    reviews: 5029,
    image: "https://m.media-amazon.com/images/I/71jWCM3KVYL.jpg",
    category: "Tablets",
    brand: "Amazon",
    badge: "Top Rated",
    description: "Powerful iPad for notes, study, media and productivity on the go.",
    highlights: ["Large Display", "All-day Battery", "Fast Performance", "Apple Pencil Support"],
    inStock: true,
  },
  {
    id: 2006,
    name: "Sony Alpha Mirrorless Camera Kit",
    price: 67990,
    originalPrice: 79990,
    discount: 15,
    rating: 4.4,
    reviews: 2788,
    image: "https://m.media-amazon.com/images/I/71Etp9En7tL._AC_UY218_.jpg",
    category: "Cameras",
    brand: "Amazon",
    description: "Mirrorless camera kit for creators with fast autofocus and crisp image quality.",
    highlights: ["24MP Sensor", "4K Video", "Fast AF", "Interchangeable Lens"],
    inStock: true,
  },
  {
    id: 2007,
    ...
    rating: 4.1,
    reviews: 3912,
    image: "https://m.media-amazon.com/images/I/717fk+DNHGL.jpg",
    category: "Fashion",
    subCategory: "Footwear",
    brand: "Amazon",
    description: "Trendy lifestyle sneakers from Amazon fashion collection for daily outfits.",
    highlights: ["Lightweight", "Cushioned Sole", "Casual Style", "All-day Comfort"],
    inStock: true,
    sizes: ["6", "7", "8", "9", "10"],
  ...
  {
    id: 2008,
    name: "MARS Matte Lipstick Set for Women",
    price: 349,
    originalPrice: 699,
    discount: 50,
    rating: 4.2,
    reviews: 9430,
    image: "https://m.media-amazon.com/images/I/41Iq6Ed+rUL._AC_UL320_.jpg",
    category: "Cosmetics",
    subCategory: "Lipstick",
    brand: "Amazon",
    badge: "Trending",
    description: "Long-lasting matte lipstick combo with smooth finish and rich shades.",
    highlights: ["Long Lasting", "Matte Finish", "Easy Application", "Travel Friendly Pack"],
    inStock: true,
  },
  {
    id: 2009,
    ...
    rating: 4.3,
    reviews: 7685,
    image: "https://m.media-amazon.com/images/I/615PyicXonL.jpg",
    category: "Footwear",
    brand: "Amazon",
    badge: "Best Seller",
    description: "Sporty running shoes with breathable upper and grip outsole.",
    highlights: ["Breathable Mesh", "Grip Sole", "Lightweight Build", "Training Ready"],
    inStock: true,
    sizes: ["6", "7", "8", "9", "10", "11"],
